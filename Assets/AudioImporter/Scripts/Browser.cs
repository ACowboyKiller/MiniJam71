...
public class Browser : MonoBehaviour
{
    ...
    private void AddFileItem(int index)
    {
        ...
        listItem.GetComponentInChildren<TMP_Text>().text = Path.GetFileName(files[index]);
    ...
    private void AddDirectoryItem(int index)
    {
        ...
        if (selectDrive)
            listItem.GetComponentInChildren<TMP_Text>().text = directories[index];
        else
            listItem.GetComponentInChildren<TMP_Text>().text = Path.GetFileName(directories[index]);
